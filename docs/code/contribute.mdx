...
The project was created during a hackathon, so I don't yet have a complete infrastructure to make contributing smooth. BUT! There is an open [issue](https://github.com/no-hive/pulse_hook/issues/4) to build such a system.
