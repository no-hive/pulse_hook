...
<Columns cols={2}>
  <Column>
    <Card title="Initialize Pool" color="#FF00F6" icon="sparkle-highlight" href="https://app.mintlify.com/mpf-hook/pulse-hook/~/b701701b-00fc-4377-af8f-7007c0f3ff0d">
      Check the networks where the hook is already deployed and initialize your pool there!
    </Card>
  </Column>
  <Column>
    <Card title="Deploy Hook" color="#FF00F6" icon="rocket" href="https://app.mintlify.com/mpf-hook/pulse-hook/~/b701701b-00fc-4377-af8f-7007c0f3ff0d">
